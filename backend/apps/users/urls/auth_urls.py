...
from ..views import UserRegistrationView, GoogleOAuthCallbackView, VerifyEmailView, ResendVerificationView, EmailDiagnosticView
...
urlpatterns = [
    ...
    path('email-diagnostic/', EmailDiagnosticView.as_view(), name='email_diagnostic'),
