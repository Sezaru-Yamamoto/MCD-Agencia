    ...
    <section id="clientes" className="section bg-gradient-to-br from-cmyk-black to-cmyk-black py-10 sm:py-14 md:py-18 lg:py-24">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-10 md:mb-12 px-4 sm:px-0">
          <h2 className="text-3xl sm:text-4xl md:text-5xl mb-4 font-bold text-white">Confían en nosotros</h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-300">
            Empresas líderes en México eligen Agencia MCD para sus campañas
            de gran formato y publicidad exterior.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-300 italic">
            +xx empresas satisfechas con nuestros servicios de impresión
          </p>
        </div>
      </div>
    </section>
