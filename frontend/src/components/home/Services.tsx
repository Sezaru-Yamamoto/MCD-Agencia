    ...
    <section id="servicios" className="section bg-gradient-to-b from-cmyk-black to-cmyk-black py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-10 md:mb-12 px-4 sm:px-0">
          <h2 className="text-3xl sm:text-4xl md:text-5xl mb-4 font-bold text-white">Soluciones de impresión para cada necesidad</h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-300">
            Ofrecemos 12 servicios especializados de impresión para impulsar tu marca
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-8">
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-gray-100">Descripción</h3>
                    <p className="text-gray-400 leading-relaxed">{selectedService.description}</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold mb-4 text-gray-100">Casos de Uso</h3>
                  ...
                  <div className="bg-cmyk-yellow/10 border border-cmyk-yellow rounded-lg p-5">
                    <p className="text-sm text-gray-200 leading-relaxed">
                      <span className="font-semibold text-cmyk-yellow">💡 Tip:</span> Contáctanos para
                      información personalizada sobre precios y tiempos de entrega.
                    </p>
                  </div>

                  <div className="border-t border-cmyk-cyan/20 pt-8">
                    <h3 className="text-lg font-semibold mb-5 text-gray-100">¿Qué deseas hacer?</h3>
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <a
                        href={`https://wa.me/522228055700?text=Hola, me interesa ${encodeURIComponent(selectedService.title)}`}
                        target="_blank"
